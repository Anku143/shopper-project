...
const Hero = () => {
  return (
    <div className="hero bg-linear-to-bl from-[#fde1ff] to-[#e1ffea22] w-full h-screen">
      <div className=" flex justify-center items-center">
        <div className="flex flex-1 flex-col gap-[20px] justify-center pl-[180px] leading-[1]">
